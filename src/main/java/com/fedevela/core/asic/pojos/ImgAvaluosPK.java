...
@Embeddable
public class ImgAvaluosPK implements Serializable {
    ...
    public ImgAvaluosPK(Long nunicodoc, Long nunicodoct) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ImgAvaluosPK)) {
            return false;
        }
        ImgAvaluosPK other = (ImgAvaluosPK) object;
    ...
    public String toString() {
        return "com.adeamx.adeadms.pojos.ImgAvaluosPK[nunicodoc=" + nunicodoc + ", nunicodoct=" + nunicodoct + "]";
    }
