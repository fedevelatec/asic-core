...
@Embeddable
public class DmsChecklistPK implements Serializable {
    ...
    public DmsChecklistPK() {
    }

    public DmsChecklistPK(BigInteger idOperation, BigInteger idProduct, BigInteger idDocument, BigInteger idGroup) {
    ...
    public boolean equals(Object object) {
        ...
        DmsChecklistPK other = (DmsChecklistPK) object;
    ...
    public String toString() {
        return "com.adeadms.core.adea.cpanel.pojos.DmsChecklistPK[idOperation=" + idOperation + ", idProduct=" + idProduct + ", idDocument=" + idDocument + ", idGroup=" + idGroup + "]";
    }
